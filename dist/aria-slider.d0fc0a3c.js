...
(function () {
  ...
  document.addEventListener('update-red', function (event) {
    var red = JSON.parse(event.detail).value;
    var green = Number(document.querySelector('#greenSlider').getAttribute('value'));
    var blue = Number(document.querySelector('#blueSlider').getAttribute('value'));
    updateColorBox(red, green, blue);
  });

  document.addEventListener('update-green', function (event) {
    var green = JSON.parse(event.detail).value;
    var red = Number(document.querySelector('#redSlider').getAttribute('value'));
    var blue = Number(document.querySelector('#blueSlider').getAttribute('value'));
    updateColorBox(red, green, blue);
  });
  document.addEventListener('update-blue', function (event) {
    var blue = JSON.parse(event.detail).value;
    var red = Number(document.querySelector('#redSlider').getAttribute('value'));
    var green = Number(document.querySelector('#greenSlider').getAttribute('value'));
    updateColorBox(red, green, blue);
  });
...
//# sourceMappingURL=/aria-slider.d0fc0a3c.map